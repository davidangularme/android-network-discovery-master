...
import info.lamatricexiste.network.AdditionService.AdditionServiceClient;
...
final public class ActivityDiscovery extends ActivityNet implements OnItemClickListener,AdditionServiceClient {
	
	   private ExampleServiceConnection mServiceConnection = new ExampleServiceConnection();
	    private AdditionService mService = null;
	...
	public  WeakReference mDiscover;
    ...
    AdditionServiceConnection connection;
	  ...
	  class AdditionServiceConnection implements ServiceConnection {
	    ...
	    public void onServiceConnected(ComponentName name, IBinder boundService) {
	      ...
	      Log.d("davidfff", "davidfff  onServiceConnected() connected");
	      Toast.makeText(ActivityDiscovery.this, "Service connected", Toast.LENGTH_LONG)
	          .show();
	    }

	    public void onServiceDisconnected(ComponentName name) {
	      service = null;
	      Log.d("davidfff", "davidfff  onServiceDisconnected() disconnected");
	      Toast.makeText(ActivityDiscovery.this, "Service connected", Toast.LENGTH_LONG)
	          .show();
	    }
	  }
	  private ArrayList<String> scanSubNet(String subnet){
		    ...
		    for(int i=1; i<30; i++){
		    	//Log.d("davidfff", "davidfff  Trying: " + subnet + String.valueOf(i));
		        try {
		            inetAddress = InetAddress.getByName(subnet + String.valueOf(i));
		            if(inetAddress.isReachable(1000)){
		                hosts.add(inetAddress.getHostName());
		                Log.d("davidfff", "davidfff inetAddress.getHostName() "+ inetAddress.getHostName());
		                Log.d("davidfff", "davidfff inetAddress.getHostName() "+ inetAddress.getAddress());
		                Log.d("davidfff", "davidfff inetAddress.getHostName() "+ inetAddress.getHostAddress());
		                Log.d("davidfff", "davidfff inetAddress.getHostName() "+ inetAddress.getLocalHost());
		            }
	  ...
	  private void initService() {
	   ...
	   // i.setClassName("com.collabera.labs.sai", "com.collabera.labs.sai.RemoteService");
	    ...
	    i.setClassName("info.lamatricexiste.network",   "info.lamatricexiste.network.AdditionService");
	    startService(i);
	   // boolean ret = bindService(i, connection, Context.BIND_AUTO_CREATE);
	    
	   // Log.d("davidfff", "davidfff  initService() bound with " + ret);
	  }
	  ...
	  private void releaseService() {
	    ...
	    connection = null;
	    Log.d("davidfff", "davidfff  releaseService() unbound.");
	  }

	  class ExampleServiceConnection implements ServiceConnection {

	        public void onServiceConnected(ComponentName name, IBinder service) {
	            mService = ((AdditionService.ExampleBinder )service).getService();

	            mService.setServiceClient(ActivityDiscovery.this);
	        }
...
//////////////////////////////
		...
		Intent serviceIntent = new Intent(this, AdditionService.class);
	//	startService(serviceIntent);
    //    initService();
    	
    //	bindService(serviceIntent, mServiceConnection, BIND_AUTO_CREATE);	
    
    	//ArrayList<String> hosts = scanSubNet("10.0.0.");
/*		InetAddress localhost = null;
		...
		try {
			...
			{
				Log.d("davidfff", "davidfff " +address + " machine is turned on and can be pinged");
			}
			else if (!address.getHostAddress().equals(address.getHostName()))
			{
				Log.d("davidfff", "davidfff " +address + " machine is known in a DNS lookup");
			}
			else
			{
				Log.d("davidfff", "davidfff " +address + " the host address and host name are equal, meaning the host name could not be resolved");
			}
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
...
*/
   ...
   // 	NetworkScan aaa4444 = new NetworkScan();
   // 	aaa4444.run();
////////////////////////////    	
    	final WifiManager manager = (WifiManager) super.getSystemService(WIFI_SERVICE);
    	final DhcpInfo dhcp = manager.getDhcpInfo();
    	WifiInfo aaa =  manager.getConnectionInfo();
    	
    	final String address = Formatter.formatIpAddress(dhcp.gateway);
    	Log.d("davidfff", "davidfff router mac addr ipAddress:"+aaa.getBSSID());
    	
    	Log.d("davidfff", "davidfff router mac addr getNetworkId:"+aaa.getNetworkId());
    	    Log.d("davidfff", "davidfff route  ipAddress:"+address);
        //dispaly them
       
       

    	
    	Log.d("davidfff", "davidfff begin ActivityDiscovery onCreate(Bundle savedInstanceState)");
    ...
    private void startDiscovering() {
        ...
        try {
            ...
            Log.d("davidfff", "davidfff method = " + method);
        } catch (NumberFormatException e) {
        	Log.d("davidfff", "davidfff error method = ");
        ...
        switch (method) {
            ...
            case 0:
            default:
            	Log.d("davidfff", "davidfff begin mDiscoveryTask");
                mDiscoveryTask = new DefaultDiscovery(ActivityDiscovery.this);
        }
        */
        mDiscoveryTask = new DefaultDiscovery(ActivityDiscovery.this);
       // Log.d("davidfff", "davidfff mDiscoveryTask "+mDiscoveryTask.get);
        Log.d("davidfff", "davidfff network_ip "+network_ip);
        Log.d("davidfff", "davidfff network_start "+network_start);
        Log.d("davidfff", "davidfff network_end "+network_end);
    ...
    private void initList() {
        ...
        Log.d("davidfff", "davidfff list "+hosts);
	...
	public void exampleServiceClientMethod() {
		Log.d("davidfff", "davidfff exampleServiceClientMethod");
